...
export function SuccessResponses<TData>(req: Request, res: Response, data: TData, options: ResponsesOptions) {
  // const logFrom = '';
  // const logText = '';
  // const logEnd = '';
  // const user = req.user ? `unknown` : "unknown";
  // logger.info(`${logFrom} ${logText} ${logEnd} by ${user}`);
